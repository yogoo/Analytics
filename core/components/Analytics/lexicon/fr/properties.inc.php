...
# shared
$_lang['analytics.prop_desc.debug'] = 'Afficher les messages d\'erreurs? Les messages d\'erreurs sont placés dans une balise <script> juste avant le code de suivi.';
$_lang['analytics.prop_desc.isLocalhost'] = 'UA - Le serveur est un serveur local ? Si oui : "cookieDomain" = "none".';
$_lang['analytics.prop_desc.excludeContextList'] = 'Liste de contextes à exclure des statistiques - valeur par défaut: \'\' - Ex: web, web2,...';
$_lang['analytics.prop_desc.excludeLoggedInUserContextList'] = 'Liste de contextes à exclure des statistiques quand l\'utilisateur a une session active dans ce contexte - valeur par défaut: \'mgr\' -  Ex: mgr, web,...';
...
$_lang['analytics.prop_desc.forceSSL'] = 'UA - Forcer Google Analytics a toujours envoyer les données en utilisant SSL, et ce même depuis une page non sécurisée (http) ?';
$_lang['analytics.prop_desc.anonymizeIP'] = 'UA - Anonymiser les adresses IP ?';
$_lang['analytics.prop_desc.displayfeatures'] = 'UA - Activer les fonctions Display Advertising ?';
